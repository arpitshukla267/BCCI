...
export default function HowWeWork() {
  ...
  return (
    <div className="relative bg-white min-h-fit overflow-hidden pb-6 px-4 mt-[30rem] md:mt-[-5rem]">
          ...
          {cards.map((card, index) => (
            ...
            >
              <div className="flex flex-col mb-8 bg-transparent items-center text-center md:p-4 transition-all duration-300 w-full">
                ...
                />
                <h3 className="md:text-xl w-45 text-md bg-orange-500 text-white font-semibold rounded-b-[100rem] md:min-h-[7rem] min-h-[6rem] md:px-5 px-10 md:py-5 py-4">
                  {card.title}
                </h3>
              </div>
            </div>
